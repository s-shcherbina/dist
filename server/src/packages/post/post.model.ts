...
import { PostNegativeReactionModel, PostReactionModel } from './post.js';
  ...
  public static get relationMappings(): RelationMappings {
    return {
      ...
      postNegativeReactions: {
        relation: Model.HasManyRelation,
        modelClass: PostNegativeReactionModel,
        join: {
          from: `${DatabaseTableName.POSTS}.id`,
          to: `${DatabaseTableName.POST_NEGATIVE_REACTIONS}.postId`
        }
      },
      user: {
        relation: Model.HasOneRelation,
